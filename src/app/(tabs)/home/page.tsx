  ...
  return (
    <div>
      <Hero
        ...
        cta={{ text: "Schedule Assessment", href: "/home/contact" }}
        secondaryCta={{ text: "View Pricing", href: "/home/pricing" }}
      />
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {[
              { title: 'About Us', icon: Shield, path: '/home/about', desc: 'Our story and mission' },
              { title: 'Our Team', icon: Users, path: '/community', desc: 'Security experts' },
              { title: 'Case Studies', icon: Award, path: '/home/case-studies', desc: 'Real success stories' },
              { title: 'Intelligence', icon: Eye, path: '/intel', desc: 'Global threat feed' },
              { title: 'Resources', icon: BookOpen, path: '/intel/resources', desc: 'Guides & reports' },
              { title: 'QFS Network', icon: Network, path: '/assets/qfs', desc: 'Quantum security' },
              { title: 'Sentinel Trust', icon: Lock, path: '/hub/research', desc: 'Zero trust' },
              { title: 'Portfolio', icon: LayoutDashboard, path: '/assets', desc: 'Asset dashboard' },
              { title: 'Pricing', icon: Zap, path: '/home/pricing', desc: 'Plans & pricing' },
              { title: 'Contact', icon: Mail, path: '/home/contact', desc: 'Get in touch' }
            ].map((item, idx) => {
