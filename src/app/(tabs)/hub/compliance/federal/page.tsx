    ...
    <div className="min-h-screen pt-20 lg:pt-0">
      ...
      <section className="py-24 bg-gradient-to-b from-transparent to-blue-600/10">
        <div className="container mx-auto px-4 text-center">
          ...
          />
          <Link href="/home/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 transition-all group">
